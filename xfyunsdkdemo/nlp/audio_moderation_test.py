"""
Audio Moderation Client Usage Example
音频合规
"""
import json
import logging
import time
import os
from xfyunsdknlp.audio_moderation_client import AudioModerationClient
...
def main():
    ...
    try:
        # 获取识别文件路径
        audioUrl = "https://api.limewire.com/sharing/download/43f3a6bd-3fbe-458e-9218-583f3244f63a"
        moderate_param = [{
            "audio_type": "mp3",
            "file_url": audioUrl,
            "name": "tts.mp3"
