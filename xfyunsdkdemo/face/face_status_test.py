"""
Face Status Client Usage Example
配合式活体检测
"""
import json
import logging
import os
import base64
from xfyunsdkface.face_status_client import FaceStatusClient
...
def main():
    ...
    try:
        ...
        if json_resp["header"]['code'] == 0:
            text = json_resp['payload']['face_status_result']['text']
